...
public class GpUserDetailsService implements UserDetailsService {
	//classe que implementa os detalhes de acesso
	//de um usuario ao sistema
	//pode-se buscar o usuario de qualquer lugar
	//aqui estao buscando também na base de dados
